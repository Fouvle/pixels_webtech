...
// Simple query to fetch all makeup products
$sql = "SELECT * FROM products WHERE category = 'makeup' ORDER BY created_at DESC";
...
<body class="min-h-screen bg-gray-50">
    ...
    <section class="max-w-6xl mx-auto px-4 py-16">
        <div class="flex justify-between items-center mb-8">
            <h2 class="text-2xl font-bold">Sustainable Makeup</h2>
        </div>
