...
<head>
  ...
  <title>Sustanify - Body Care</title>
...
<body class="min-h-screen bg-gray-50">
  ...
  <section class="max-w-6xl mx-auto px-4 py-16">
    <div class="flex justify-between items-center mb-8">
      <h2 class="text-2xl font-bold">Sustainable Bodycare Products</h2>
    ...
    <div class="grid md:grid-cols-4 gap-6">
      ...
      if ($result->num_rows > 0) {
        // Output each bodycare product from the database
  ...
  <script src="../assets/js/bodycare.js"></script>
</body>
</html>